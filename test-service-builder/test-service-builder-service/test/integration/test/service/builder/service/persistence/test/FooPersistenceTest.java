...
package test.service.builder.service.persistence.test;
...
import test.service.builder.service.FooLocalServiceUtil;
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			...
			new TransactionalTestRule(
				Propagation.REQUIRED, "test.service.builder.service"));
